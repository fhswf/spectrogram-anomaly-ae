...
The first notebook downloads the original Mendeley dataset, extracts the raw `.mat` files, and creates labeled 2.5-second windowed vibration segments. The Bosch CNC dataset is prepared with `scripts/prepare_cnc_machining_dataset.py`.
